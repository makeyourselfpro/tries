...
const page = () => {
  return (
    <main>
      ...
      <section className="p-44 space-y-5">
      ...
      <section className="flex items-center p-10 gap-20">
        <div className="w-2/6">
      ...
      <section className="p-44 space-y-5">
        <p className="text-4xl font-semibold w-3/6">
          Our process is completely
          flawless and modern.
        </p>
        <div className="text-md text-gray-500  w-3/6">
      ...
      <section className="p-20 grid grid-cols-3">
      ...
      <div className="flex items-center px-20 gap-10">
        <img src="https://www.artimization.com/wp-content/uploads/2019/12/custom-responsive-website-1.jpg.webp" alt="" className='rounded-2xl w-2/5' />
      ...
      <section className="p-10">
        <div className="p-20 px-32 space-y-5 text-center border">
          <div className="text-4xl font-semibold">
      ...
      <div className="p-20 flex flex-col justify-center items-center space-y-5">
        ...
        <div className="text-lg text-center w-4/6">
        ...
        <div className="grid grid-cols-4 py-10 gap-3">
          ...
          <div className="bg-[url('https://www.artimization.com/wp-content/uploads/2022/11/ashray-300x204.jpg')] p-32 rounded"></div>
          <div className="bg-[url('https://www.artimization.com/wp-content/uploads/2022/11/matrix-300x204.jpg')] p-32 rounded"></div>
          <div className="bg-[url('https://www.artimization.com/wp-content/uploads/2022/11/tradify-300x204.jpg')] p-32 rounded"></div>
          <div className="bg-[url('https://www.artimization.com/wp-content/uploads/2022/11/cbd-300x204.jpg')] p-32 rounded"></div>
          <div className="bg-[url('https://www.artimization.com/wp-content/uploads/2022/11/cbd-1-300x204.jpg')] p-32 rounded"></div>
          <div className="bg-[url('https://www.artimization.com/wp-content/uploads/2022/11/shanti-1-300x204.jpg')] p-32 rounded"></div>
          <div className="bg-[url('https://www.artimization.com/wp-content/uploads/2022/11/cosmia-1-300x204.jpg')] p-32 rounded"></div>
