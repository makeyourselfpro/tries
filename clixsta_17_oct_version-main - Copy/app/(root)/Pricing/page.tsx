...
const page = () => {
  ...
  return (
    <div>
      <div className={`grid grid-cols-2 px-20 py-10  pt-32  h-[100vh] gap-20 ${currentTheme === "dark" ? "bg-[#172d41] text-gray-100" : "bg-gray-200 white text-black"}`}>
      ...
      <div className="p-20 flex gap-20 px-44">
...
The majority of our sites are produced to perform flawlessly on each device.
      ...
      <div className="flex p-20 gap-44 ">
      ...
      <div className="flex p-20  gap-44  bg-white text-black">
        <div className="w-3/5 flex flex-col justify-center space-y-5">
          <div className="text-4xl font-semibold">Finding Ecommerce <br />
            To Sell your Products?</div>
          <div className="text-md">
        ...
        <div className="pl-20 flex flex-col space-y-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="flex flex-col space-y-3">
              ...
              <div className="text-sm">2 Logo Design Concepts</div>
