...
{/* Header */}
      <header className="grid grid-cols-1 lg:grid-cols-2 p-10 lg:p-20 lg:py-10 text-white h-[120vh] bg-[url('https://images.unsplash.com/photo-1497091071254-cc9b2ba7c48a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTV8fGRlc2lnbnxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=500&q=60')] bg-center bg-cover no-repeat">
        <div className="space-y-7 flex flex-col justify-center  pt-14">
          ...
          <div className="text- md lg:text-lg lg:text-3xl font-semibold">
      ...
      <section className="flex text-center flex-col justify-center items-center p-10 lg:p-20 space-y-5">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10">
          <div className="text-start p-10 gap-2 flex flex-col border-r justify-start items-start">
            ...
            <div className="text- md lg:text-lg lg:text-3xl font-semibold">Branding
              Development</div>
          ...
          <div className="text-start pt-10 pl-10 gap-2 flex flex-col border-r justify-start items-start">
            ...
            <div className="text- md lg:text-lg lg:text-3xl font-semibold">Digital <br />
              Marketing</div>
            <div className="text-sm text-gray-500">
          ...
          <div className="text-start p-10 gap-2 flex flex-col border-r justify-start items-start">
            ...
            <div className="text- md lg:text-lg lg:text-3xl font-semibold">Website
              Development</div>
            <div className="text-sm text-gray-500">
          ...
          <div className="text-start p-10  gap-2 flex flex-col  justify-start items-start">
            ...
            <div className="text- md lg:text-lg lg:text-3xl font-semibold">Graphic <br />
              Design</div>
            <div className="text-sm text-gray-500">
              Logo Design
              Borchure Design
